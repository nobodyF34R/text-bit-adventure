...
def e():
 ...
 while c(1)>0:
  ...
  while(c(6),c(5))==(112,0)or not c(6)in[97,112,100]or(c(6),A[60]+A[59])==(97,2):print("\x1B[2JNo more potions!")if c(6)==112 else print("\x1B[2JToo exausted.")if(c(6),A[60]+A[59])==(97,2)else print("\x1B[2JPlayer stats:\npotion amount:",c(5),"\ncurrent health:",c(3),"\nmax health:",c(4),"\nstrength:",c(2),"\n\nenemy stats:\nhealth:",c(1),"\nstrength:",c(),("\n\nNice."if c(5)in[69,169]or c(3)in[169,69]else""))if c(6)in[115,108]else print("\x1B[2JInvalid action.");a(ord((input("\nDo you "+(""if A[60]+A[59]==2 else"attack, ")+"potion, defend or look at stats?\n: ")+" ").lower()[0]),6)
