...
def e():
 ...
 while c(1)>0:
  ...
  if c(6)==97:print("\x1B[2JYou attack!\nYou do",c(2),"damage!");a(0,1)if c(1)-c(2)<1 else a(c(1)-c(2),1);print(f"Enemy health is now {c(1)}.");b(63);b(59,1)if A[60]==1 else b(60,1)
  elif c(6)==112:
...
a(5,4);a(2,2);a(2,5)
if c(0)==9:a(1);a(20,4);a(20,2);a(20,5)
if c(0)==8:a(5);(20,2)
if c(0)==7:a(1);a(100,5)
if c(0)==6:b(56);a(5);a(255,4);a(255,2);a(255,5);b(61,1)
a(c(4),3)
